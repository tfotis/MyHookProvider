...
class MyHookProvider_Version extends Zikula_AbstractVersion
{
    ...
    {
         $bundle = new Zikula_HookManager_ProviderBundle($this->name, 'modulehook_area.myhookprovider.mhp', 'ui', __('MyHookProvider Hook Handlers'));
         ...
         $bundle = new Zikula_HookManager_ProviderBundle($this->name, 'modulehook_area.myhookprovider.mhpfilter', 'filter', __('MyHookProvider Hook Handler Filter'));
